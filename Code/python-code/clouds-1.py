...
class   CloudWindow ( Window.RotationWindow ):
	def __init__ ( self, w, h, t ):
		super().__init__ ( w, h, t )
		self.eye   	= glm.vec3 ( 0, 0, 7 )
		self.fov   	= 1.4
		self.noise 	= Texture.Texture.as3D ( "noise/noiseErosionPacked.tga", 32, 32, 32 )
		self.mesh  	= Screen.Screen ()
		self.shader	= Program.Program ( glsl = "clouds-2.glsl" )
...
def main():
	win = CloudWindow ( 600, 600, "Volumetric Cloud 1" )
	win.run ()
