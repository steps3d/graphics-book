...
class   SDFWindow ( Window.RotationWindow ):
	def __init__ ( self, w, h, t ):
		...
		self.fov   	= 1.4
		self.noise 	= Texture.Texture.as3D ( "noise/noiseErosionPacked.tga", 32, 32, 32, True )     # use as alpha only
		self.blueNoise = Texture.Texture ( "noise/blue-noise.bmp" )
		self.mesh  	= Screen.Screen ()
		self.shader	= Program.Program ( glsl = "clouds-3.glsl" )
...
def main():
	win = SDFWindow ( 600, 600, "Volumetric Cloud 2" )
	win.run ()
