...
class   SDFWindow ( Window.RotationWindow ):
    def __init__ ( self, w, h, t, shader ):
        ...
        self.shader   = Program.Program ( glsl = shader if shader else "sdf-torus-tex.glsl" )
        self.shader.use ()
    ...
    def redisplay ( self ):
        ...
        #print ( 'eye', self.eye, 'rot', self.rot )
        #print ( 'lookAt', glm.lookAt ( self.eye, glm.vec3 ( 0, 0, 0 ), glm.vec3 ( 0, 1, 0 ) ) )
