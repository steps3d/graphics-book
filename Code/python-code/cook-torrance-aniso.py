...
class   MyWindow ( Window.RotationWindow ):
    def __init__ ( self, w, h, t ):
        ...
        self.shader   = Program.Program ( vertex = "cook-torrance-aniso.vsh", fragment = "cook-torrance-aniso.fsh" )
        self.shader.use ()
...
def main():
    win = MyWindow ( 900, 900, "Anisotropic Cook-Torrance shading model" )
    win.run ()
